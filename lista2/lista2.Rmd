...
#Altura
hist(dados$Altura, breaks = 8, xlab = "Altura", ylab = "Frequência", 
     main = "Histograma para a variável Altura")
#Peso
hist(dados$Peso, breaks = 8, xlab = "Peso", ylab = "Frequência", 
     main = "Histograma para a variável Peso")
#Coltot
hist(dados$Coltot, breaks = 8, xlab = "Coltot", ylab = "Frequência", 
     main = "Histograma para a variável Coltot")
#HDL
hist(dados$HDL, breaks = 8, xlab = "HDL", ylab = "Frequência", 
     main = "Histograma para a variável HDL")
#HA
hist(dados$HA, breaks = 8, xlab = "HA", ylab = "Frequência", 
     main = "Histograma para a variável HA")
#LDL
hist(dados$LDL, breaks = 8, xlab = "LDL", ylab = "Frequência", 
     main = "Histograma para a variável LDL")

#Lesões
hist(dados$Lesoes, breaks = 8, xlab = "Lesões", ylab = "Frequência", 
     main = "Histograma para a variável Lesões")
```
